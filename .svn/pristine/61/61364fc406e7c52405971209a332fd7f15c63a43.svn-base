...
//            return String.format("%s%s", hexSend, i9).toUpperCase();
            byte[] data2 = new byte[]{(byte) index0, (byte) index1, (byte) index2, (byte) index3,
                    (byte) index4, (byte) index5, (byte) index6, (byte) index7, (byte) index8, (byte) index9};
            return ZHexUtil.encodeHexStr(data2).toUpperCase();
        }
        return "";
    }
