...
//    int crc = CRC16M.calcCrc16(HexUtil.hexStringToBytes());
    String head="26445A20";
    StringBuffer buffer=new StringBuffer();
   String year= HexUtil.str2HexStr(DateUtil.getyaer().substring(2, 4));
    String monht=HexUtil.str2HexStr(DateUtil.getMonth_year());
    String date= HexUtil.str2HexStr(DateUtil.getDateofMonth());
    String hour=HexUtil.str2HexStr(DateUtil.getHour());
    String min=HexUtil.str2HexStr(DateUtil.getMimnter());
    buffer.append(head)
        .append(year).append("20")
        .append(monht).append("20")
        .append(date).append("20")
        .append(hour).append("20")
        .append(min).append("20");
    System.out.println(CRC16M.calcCrc16(HexUtil.hexStringToBytes(buffer.toString())));
    buffer.append("06")
        .append(HexUtil.str2HexStr( CRC16M.calcCrc16(HexUtil.hexStringToBytes(buffer.toString()))+"")).append("0D");
